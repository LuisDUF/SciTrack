  ...
  <v-app style="background-color: rgba(14, 73, 201, 0.24);">
      ...
      <v-main >
        <div style="width: 100%; margin-top: 3vw;  text-align: center; margin-bottom: 2vw;">
                    ...
                    <br>
                    <button @click="descargarPDF(1)" class="px-10 py-2 rounded my-3" style="color: aliceblue; background-color: #062A78;">Formato de incorporación</button>
                    <button @click="descargarPDF(2)" class="px-10 py-2 rounded my-3 mx-3" style="color: aliceblue; background-color: #062A78;">Convocatoria PIIM 2025</button>
                    <button @click="descargarPDF(3)" class="px-10 py-2 rounded my-3" style="color: aliceblue; background-color: #062A78;">Formato de renovación</button>
    ...
    <loading-overlay :value="loading">
      <img v-show="loading" src="../assets/loading_scitrack.gif" class="loading-gif">
    </loading-overlay>


      <v-container class="pa-0">
     <v-card-title  class="text-center justify-center mb-2" style="width: 100%; font-size: 2.8vw; color: #062A78;">Registro de candidato</v-card-title>
                   <v-alert
                v-if="confirmAlert"
                type="error"
                dismissible
...
>
  ...
  <v-date-picker
    ...
    @input="$refs.menu.save(form.fechaNacimiento)"
  >
    <v-spacer></v-spacer>
    ...
    <v-btn text color="primary" @click="$refs.menu.save(form.fechaNacimiento)">OK</v-btn>
              ...
              <v-text-field
                :value="form.curp"
                @input="form.curp = $event.toUpperCase()"
                label="CURP"
              ...
              <v-text-field
              :value="form.rfc"
              @input="form.rfc = $event.toUpperCase()"
              label="RFC"
              ...
              <v-select
                ...
                :items="gradosEstudios"
                item-text="nombre"
                item-value="idGradoDeEstudios"
              ...
              <v-file-input
                ...
                multiple
                @change="actualizarTablaArchivos"
        ...
        <div  style="width: 100%; justify-content: center; text-align: center;" >
          <v-btn  class="mt-3" color="#062A78" style="color: aliceblue;" @click="sendData">Confirmar</v-btn>
        </div>
      </v-container>
